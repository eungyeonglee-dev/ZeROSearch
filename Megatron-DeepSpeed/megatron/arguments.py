...
def _add_network_size_args(parser):
    ...
    # add balance
    group.add_argument('--balance', type=str, default=None, 
                       help='List of number of layers per pipeline stage')
    group.add_argument('--imbalance-tp-groups', type=str, default=None,
                       help='List of number of TP degree per pipeline stage')   
...
def _add_logging_args(parser):
    ...
    group.add_argument('--layer-profile',
                       action='store_true',
                       help='Profile transformer layer excution time')
    group.add_argument('--layer-profile-2',
                       action='store_true',
                       help='Profile transformer layer excution time')
    group.add_argument('--nsys-profile',
                       action='store_true',
                       help='Profile nsight systems')
    group.add_argument('--ds-profile',
                       action='store_true',
                       help='Using deepspeed flops profile')
    group.add_argument('--layer-profile-save',
                       action='store_true',
                       help='save profile result to csv file format')
    group.add_argument('--layer-profile-save-dir', type=str, default='',
                       help='Path to save the result of layer profile.')
