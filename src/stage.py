class StageTime:
    ...
    def __init__(self, num_mb, comp_time, for_send_time, back_send_time, dp_method):
        self.num_mb = num_mb
        self.fwbw_times = 2.0
        self.profile_cost_times = 3.0
        if dp_method in ["zero0","zero1"]:
            self.fwbw_times = 3.0
            self.profile_cost_times = 4.0
        self.forward_time = comp_time/self.profile_cost_times # original layer comp time
        self.backward_time = self.fwbw_times * comp_time/self.profile_cost_times # original layer comp time 
...
class PPGroup:
    def __init__(self, num_mb, pp_degree, stage_comp_time_lst, stage_for_send_time_lst, stage_back_send_time_lst, dp_method):
        self.num_mb = num_mb
        ...
        self.__set_stage_time_lst(dp_method)
        self.__compute_num_warmup_mb()
        self.__compute_num_remain_mb()
    
    def __set_stage_time_lst(self, dp_method):
        self.stage_time_lst = []
